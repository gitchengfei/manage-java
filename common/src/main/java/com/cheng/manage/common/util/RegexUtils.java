...
public class RegexUtils {
     ...
     * 验证日期（年月日）
     *
     * @param date 日期，格式：1992-09-03,支持闰年,平年
     * @return 验证成功返回true，验证失败返回false
     */
    ...
    /**
     * 验证用户名 4到16位（字母，数字，下划线，减号）首位必须是字母
     * @param username
     * @return
     */
    public static boolean checkUsername(String username) {
        String regex = "[a-zA-Z_][a-zA-Z0-9_-]{3,16}";
        return Pattern.matches(regex, username);
    }

    /**
     * 验证密码 密码长度在6-16位并且同时包含字母数字特殊字符
     * @param password
     * @return
     */
    public static boolean checkPassword(String password) {
        String regex = "(?![a-zA-z]+$)(?!\\d+$)(?![!@#$%^&*]+$)(?![a-zA-z\\d]+$)(?![a-zA-z!@#$%^&*]+$)(?![\\d!@#$%^&*]+$)[a-zA-Z\\d!@#$%^&*]{6,16}";
